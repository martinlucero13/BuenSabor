...
export default function StockIngredientesComprar({ handleShow, datoRow }) {
    ...
    async function handleSubmit() {
        ...
        try {
            ...
            const { data: editStockIngredientes } = await api.post('stockIngredientes/editStockActualIngredientes', { fromData: dataToSend })
        ...
        <>
            <main>
                <div>
                    ...
                    <button onClick={handleSubmit} disabled={disabledSend} className={disabledSend || loading ? 'button_disabled' : 'button'}>Comprar</button>
