...
import ShowImage from "../RubrosProductos/ShowImage";
import Loading from '../Loading/Loading'
import apiFeco from "../../Services/apiServices";
import UserContext from "../../context/userContext";


export default function ProductoImagen({ handleShow, datoRow }) {
    ...
    async function handleSubmit() {
        ...
        try {
            const dataToSend = {
                ...filesArray[0],
                imagen: datoRow.imagen
            }
            const { data: saveReintegrate } = await apiFeco.post('stockProductos/saveImg', { fromData: dataToSend })
    ...
    return (
        <>
            ...
            <main>
                <div>
                    <h2>Cargar Imagen</h2>
                    <h4>{datoRow ? datoRow.denominacion : ''}</h4>
