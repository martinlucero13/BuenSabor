...
export default function EmpleadosEdit({ handleShow, datoRow }) {
    const INITIAL_STATE = {
        usuario: datoRow ? datoRow.usuario : '',
        clave: datoRow ? datoRow.clave : '',
        rol: datoRow ? datoRow.rol : '',
    ...
    async function handleSubmit() {
        ...
        try {
            ...
            const { data: editEmpleados } = await api.post('empleados/editEmpleados', { fromData: dataToSend })
            if (editEmpleados.statusCode === 200) {
