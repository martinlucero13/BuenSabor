...
export default function Pedido({ articulo, deleteArticulo, modificarCantidad }) {
    const [cantidad, setCantidad] = useState(0)

    const descuento = articulo.precioIVA - (articulo.precioIVA * (articulo.DESCUENTO / 100))
    ...
    return (
        <>
            <main>
                ...
                <div>
                    <button onClick={() => modificarCantidad(articulo.id, -1)}>-</button>
                    <p>{cantidad}</p>
                    <button onClick={() => modificarCantidad(articulo.id, 1)}>+</button>
                </div>
                <section>
