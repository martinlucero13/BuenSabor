...
export default function RubroIngredientesForm({ handleShow }) {
    ...
    async function handleSubmit() {
        ...
        try {
            ...
            const { data: create } = await api.post('rubroProductos/createRubroProductos', { fromData: dataToSend })
            ...
            <main>
                <div>
                    ...
                    <section className={transition ? "element-hidden" : "element"}>
                        ...
                        <input placeholder="productos" maxLength={200} onChange={handleChangeForm} value={formData.denominacion} type="text" name="denominacion" />
                    </section>
                    <section>
                        <label>Estado</label>
